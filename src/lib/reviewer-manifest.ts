...
const SUBJECT_ITEM_TYPES: SubjectItemType[] =
  ['reviewer', 'strategy', 'exam', 'preboards-2025', 'preboards-set2', 'preboards-set3', 'preboards-set4', 'preboards-set5']
...
function fileFor(code: string, type: SubjectItemType): string {
  ...
  const files: Record<SubjectItemType, string> = {
    ...
    'preboards-set5': `${code}-Preboards-Set5.html`,
  }
  return files[type]
}
...
const INTERACTIVE_ITEMS: Item[] = [
  ...
  { id: 'int.D2-Vertex-Effective-Power-Interactive', subject: 'D', type: 'interactive', label: 'D2 Vertex & Effective Power', path: '/top2/D-Theoretical-Optics-Dispensing-CL/D2-Ophthalmic-Lenses-and-Dispensing/D2-Vertex-Effective-Power-Interactive.html' },
  ...
  // Companion practical-station drill: B&L one-position keratometer (focus, axis, the two
  // meridians, keratoconus recognition, and Javal's rule).
  { id: 'int.D-Virtual-Keratometer', subject: 'D', type: 'interactive', label: 'D Virtual Keratometer', path: '/top2/D-Theoretical-Optics-Dispensing-CL/D-Virtual-Keratometer.html' },
...
const CARD_ITEMS: Item[] = [
  ...
  { id: 'card.A1-Exam426-Fixes-Card', subject: 'A', type: 'card', label: 'Card 8 · Exam 426 fixes', path: '/top2/A-Visual-Biology/A1-Human-Biology-Systems/A1-Exam426-Fixes-Card.html' },
  ...
  { id: 'card.C2-Preboard-Refraction-Fixes-Card', subject: 'C', type: 'card', label: 'Card 7 · Refraction fixes', path: '/top2/C-Primary-Care-and-Refraction/C2-Ametropia-and-Refractive-Errors/C2-Preboard-Refraction-Fixes-Card.html' },
  ...
  { id: 'card.G5-Drug-Induced-Ocular-Signs-and-Toxidromes-Card', subject: 'G', type: 'card', label: 'Card 8 · Drug tox', path: '/top2/G-Ocular-Pharmacology/G5-Special-Populations-and-Drug-Effects/G5-Drug-Induced-Ocular-Signs-and-Toxidromes-Card.html' },
...
const EXTRA_SUBJECT_ITEMS: Item[] = [
  ...
  { id: 'G.preboards-set6', subject: 'G', type: 'preboards-set6', label: 'Ocular Pharmacology — Preboards Set 6',
    sub: '100-item Set 6 mock-board bank; Quiz / Exam / Study modes',
    path: '/top2/G-Ocular-Pharmacology/G-Preboards-Set6.html' },
  ...
  { id: 'B.preboards-set6', subject: 'B', type: 'preboards-set6', label: 'Physiologic Optics & BV — Preboards Set 6',
    sub: '121-item Set 6 mock-board bank; Quiz / Exam / Study modes',
    path: '/top2/B-Physiological-Optics-and-BV/B-Preboards-Set6.html' },
  ...
  { id: 'H.preboards-set6', subject: 'H', type: 'preboards-set6', label: 'Jurisprudence, Ethics & Public Health — Preboards Set 6',
    sub: '189-item Set 6 mock-board bank; Quiz / Exam / Study modes',
    path: '/top2/H-Jurisprudence-and-Ethics/H-Preboards-Set6.html' },
]
