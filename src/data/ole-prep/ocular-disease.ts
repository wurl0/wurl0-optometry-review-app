  ...
  sections: [
    {
      ...
      items: [
        ...
        {
          kind: 'mnemonic',
          term: 'Bacterial Conjunctivitis Duration (HAC)',
          device: 'Hyperacute = Hours; Acute = less than 3 weeks; Chronic = more than 4 weeks',
          breakdown: 'Hyperacute bacterial conjunctivitis = caused by Neisseria gonorrhoeae (most common); profuse purulent discharge; can penetrate intact corneal epithelium. Acute = Staph aureus (most common); <3 weeks. Chronic = Staph aureus; >4 weeks; associated with blepharitis.',
        },
        {
          kind: 'mnemonic',
          term: 'Nanophthalmos vs Microphthalmos',
          device: 'Nano = Normal inside, Micro = Malformed',
          breakdown: 'Nanophthalmos = small eye with NORMAL internal structures; thickened sclera and choroid; high hyperopia; normal lens volume. Microphthalmos = small AND MALFORMED eye; associated with colobomas and cyst. Both are small eyes — the key difference is whether internal structures are normal.',
        },
        {
          kind: 'mnemonic',
          term: 'VKC Duration — "4 Years in Warm Weather"',
          device: 'Vernal = Warm + 4 years + Males under 20',
          breakdown: 'Vernal Keratoconjunctivitis: lasts an AVERAGE of 4 YEARS; most common in WARM and DRY climates; affects MALES under 20 years old. Caused by hypersensitivity to AIRBORNE ALLERGENS. These 3 facts are the most tested VKC demographics.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          kind: 'fact',
          content: 'Chlamydial inclusion conjunctivitis vs Trachoma: BOTH caused by Chlamydia trachomatis, but follicle location is opposite. Inclusion conjunctivitis = follicles at INFERIOR bulbar and palpebral conjunctiva. Trachoma = follicles at UPPER tarsal conjunctiva with pannus at upper limbus. Chlamydia is also the most common STD in the United States.',
          highlight: 'Chlamydial inclusion = inferior follicles; Trachoma = upper tarsal follicles — opposite locations, same organism',
        },
        {
          kind: 'fact',
          content: 'Herpes Zoster Ophthalmicus (HZO) involves the ophthalmic division of the trigeminal nerve (CN V1) and is the leading cause of blindness from corneal disease in the United States. Hutchinson\'s sign (rash on the TIP OF THE NOSE from nasociliary branch involvement) predicts ocular complications. 50% of HZO patients manifest conjunctivitis.',
          highlight: 'HZO = CN V1; Hutchinson\'s sign (nose tip rash) = high risk of eye involvement; leading corneal blindness cause in US',
        },
        {
          kind: 'fact',
          content: 'Adenoviral conjunctivitis is the MOST COMMON cause of acute UNILATERAL pink eye. It presents with photophobia, watery-mucoid discharge, and diffuse conjunctival vessel engorgement. It is NOT bacterial — there is no mucopurulent discharge. Viral conjunctivitis shows FOLLICLES (not papillae) and periauricular lymphadenopathy.',
          highlight: 'Adenovirus = most common acute unilateral pink eye; watery discharge; follicles + periauricular LAP',
        },
        {
          kind: 'fact',
          content: 'Atopic Keratoconjunctivitis (AKC) is associated with atopic dermatitis (eczema) in 95% of cases. Unlike simple seasonal allergic conjunctivitis, AKC has significant CORNEAL involvement — ranging from punctate corneal erosions to epithelial filaments and defects. It is chronic (not seasonal) and can threaten vision.',
          highlight: 'AKC = 95% associated with atopic dermatitis; chronic + corneal involvement (not just conjunctivitis)',
        },
        {
          kind: 'fact',
          content: 'Nanophthalmos is a small eye with NORMAL internal structures, thickened sclera and choroid, high hyperopia, and normal lens volume. Microphthalmos is a small MALFORMED eye with colobomas and cysts. Macrophthalmia is enlargement of the globe in all directions. Buphthalmos is increase in size of both anterior and posterior globe from congenital glaucoma.',
          highlight: 'Nanophthalmos = normal structures in small eye (high hyperopia); Microphthalmos = malformed small eye',
        },
        {
          kind: 'fact',
          content: 'External hordeolum (MOST COMMON type of stye) forms on the OUTER eyelid from infection of the GLAND OF ZEIS. Internal hordeolum forms on the INNER eyelid from infection of the MEIBOMIAN GLAND. Both are acute, painful, tender, and treated with I&D — unlike chalazion (chronic, painless, Meibomian duct blockage, treated with I&C).',
          highlight: 'External stye = Zeis gland (outer lid, most common); Internal stye = Meibomian gland (inner lid)',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          kind: 'trap',
          question: 'Chlamydial inclusion conjunctivitis vs Trachoma — where are the follicles?',
          wrong: 'Both show follicles at the upper tarsal conjunctiva because both are caused by Chlamydia trachomatis',
          correct: 'OPPOSITE locations. Trachoma = UPPER tarsal conjunctiva (+ pannus at upper limbus). Chlamydial inclusion conjunctivitis = INFERIOR bulbar and palpebral conjunctiva.',
          why: 'Same organism (Chlamydia trachomatis), entirely different follicle location. The board uses this to trap students who know trachoma but forget the inclusion conjunctivitis presentation. Trachoma = upper. Inclusion = inferior. Always.',
        },
        {
          kind: 'trap',
          question: 'Nanophthalmos vs Microphthalmos — are they the same?',
          wrong: 'Both are small eyes with abnormal internal structures',
          correct: 'Nanophthalmos = small eye with NORMAL internal structures (thickened sclera/choroid, high hyperopia, normal lens). Microphthalmos = small MALFORMED eye with colobomas and cysts.',
          why: 'The names sound similar but the key differentiator is whether internal structures are normal. Nanophthalmos = structurally normal but everything is smaller + thicker. Microphthalmos = structurally abnormal. The high hyperopia in nanophthalmos is a classic clinical clue.',
        },
        {
          kind: 'trap',
          question: 'External vs Internal Hordeolum — which is more common?',
          wrong: 'Internal hordeolum (Meibomian stye) is more common because Meibomian glands are larger',
          correct: 'EXTERNAL hordeolum (Zeis gland) is the MOST COMMON type. It forms on the outer eyelid surface. Internal (Meibomian) is less common and forms on the inner lid.',
          why: 'Most sources conflate hordeolum with Zeis gland infection without specifying the external type is more common. Internal hordeolum can also be confused with chalazion — both involve the Meibomian gland — but internal hordeolum is acute and tender, while chalazion is chronic and painless.',
        },
        {
          kind: 'trap',
          question: 'Does pterygium cause visual symptoms from the start?',
          wrong: 'Yes, pterygium always reduces vision because it grows onto the cornea',
          correct: 'NO. Pterygium causes NO visual symptoms unless the fibrovascular growth extends to the cornea and approaches the visual axis. Peripheral pterygium causes no symptoms.',
          why: 'Pterygium growing onto the cornea destroys Bowman\'s membrane and can cause induced astigmatism or obstruct the visual axis — but only once it reaches a certain size. Early/peripheral pterygium is visually silent. The board may test this by describing a nasal fibrovascular growth with no symptoms and asking for the diagnosis.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          kind: 'recall',
          prompt: 'Differentiate Nanophthalmos from Microphthalmos across 4 features.',
          answer: '1. Size: Both are small eyes. 2. Internal structures: Nanophthalmos = NORMAL; Microphthalmos = MALFORMED (colobomas, cysts). 3. Refractive error: Nanophthalmos = HIGH HYPEROPIA (normal lens volume in a smaller eye); Microphthalmos = variable. 4. Sclera: Nanophthalmos = THICKENED sclera and choroid; Microphthalmos = variable. Key phrase: Nanophthalmos = "normal in miniature." Microphthalmos = "small and broken."',
        },
        {
          kind: 'recall',
          prompt: 'List the 3 forms of conjunctivitis caused by Chlamydia trachomatis and the distinguishing follicle location for inclusion conjunctivitis vs trachoma.',
          answer: '1. Trachoma — UPPER tarsal conjunctiva follicles; pannus at upper limbus; chronic; leading infectious cause of blindness worldwide; drug of choice = tetracycline. 2. Adult inclusion conjunctivitis — INFERIOR bulbar and palpebral conjunctiva follicles; associated with genital chlamydial infection. 3. Neonatal inclusion conjunctivitis (Ophthalmia neonatorum) — presents at 5-14 days of life. CRITICAL DISTINCTION: Trachoma = upper. Inclusion conjunctivitis = inferior.',
        },
        {
          kind: 'recall',
          prompt: 'Name the five subtypes of allergic conjunctivitis and the key feature of each.',
          answer: '1. Seasonal (SAC) — ragweed, pollen, dander; recurrent, transient, self-limiting; most common type. 2. Perennial (PAC) — house dust mite; year-round; rarer than SAC. 3. Atopic Keratoconjunctivitis (AKC) — 95% associated with atopic dermatitis; severe, chronic; corneal involvement (erosions, filaments). 4. Vernal (VKC) — airborne allergens; males <20; warm dry climates; lasts 4 years average; cobblestone papillae; shield corneal ulcers. 5. Giant Papillary (GPC) — contact lenses, prosthesis, sutures; papillae on upper tarsal; CL intolerance.',
        },
        {
          kind: 'recall',
          prompt: 'What are the 3 bacterial conjunctivitis subtypes by duration and their most common causative organism?',
          answer: '1. Hyperacute (Purulent) — rapid onset; Neisseria gonorrhoeae (most common); also N. meningitidis, Staph, Strep, Pseudomonas; can penetrate intact corneal epithelium; acquired by autoinoculation from genitalia. 2. Acute (Mucopurulent) — <3 weeks; Staphylococcus aureus (most common); also Strep pneumoniae, Haemophilus; common across all ages. 3. Chronic — >4 weeks; Staphylococcus aureus; associated with blepharitis as continuous source.',
        },
        {
          kind: 'recall',
          prompt: 'What is Herpes Zoster Ophthalmicus (HZO)? What is Hutchinson\'s sign?',
          answer: 'HZO = herpes zoster virus reactivation involving the ophthalmic division of the trigeminal nerve (CN V1). It is the LEADING CAUSE of blindness from corneal disease in the United States. 50% of HZO patients develop conjunctivitis. Hutchinson\'s sign = rash on the TIP OF THE NOSE — occurs when the nasociliary branch of CN V1 is involved; predicts HIGH RISK of ocular complications (uveitis, keratitis, conjunctivitis) because the nasociliary branch also supplies the eye.',
        },
      ],
    },
  ],
