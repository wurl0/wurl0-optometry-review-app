...
export const generalAnatomyQuiz: NotesQuizData = {
  ...
  questions: [
    ...
    {
      kind: 'mcq',
      stem: 'Which of the four fundamental tissue types conducts impulses and controls body functions?',
      options: ['Epithelial', 'Connective', 'Muscular', 'Nervous'],
      correct: 3,
      answer: 'Nervous tissue conducts impulses and controls body functions. Epithelial tissue covers surfaces and lines cavities, connective tissue connects and supports, and muscular tissue produces movement.',
    },
    {
      kind: 'mcq',
      stem: 'Which fundamental tissue type covers body surfaces and lines hollow organs and cavities?',
      options: ['Epithelial', 'Connective', 'Muscular', 'Nervous'],
      correct: 0,
      answer: 'Epithelial tissue covers external surfaces and lines hollow organs and cavities. Connective tissue supports and binds, muscular tissue contracts, and nervous tissue conducts impulses.',
    },
    {
      kind: 'mcq',
      stem: 'The dorsal body cavity is subdivided into the cranial cavity and the:',
      options: ['thoracic cavity', 'spinal cavity', 'abdominal cavity', 'pelvic cavity'],
      correct: 1,
      answer: 'The dorsal cavity houses the central nervous system and divides into the cranial cavity (brain) and the spinal cavity (spinal cord). The thoracic, abdominal, and pelvic cavities belong to the ventral cavity.',
    },
    {
      kind: 'mcq',
      stem: 'Which organ is contained within the thoracic cavity?',
      options: ['Liver', 'Heart', 'Urinary bladder', 'Spleen'],
      correct: 1,
      answer: 'The thoracic (ventral) cavity holds the heart, trachea, bronchi, esophagus, and thymus. The liver, spleen, and bladder lie in the abdominopelvic cavity.',
    },
    {
      kind: 'mcq',
      stem: 'By shape, the carpals of the wrist and the tarsals of the ankle are classified as which type of bone?',
      options: ['Long', 'Short', 'Flat', 'Irregular'],
      correct: 1,
      answer: 'Carpals and tarsals are short (roughly cubical) bones. Long bones are tubular (humerus, femur), flat bones have two compact layers around spongy bone (skull, sternum), and irregular bones have mixed shapes (vertebrae).',
    },
    {
      kind: 'mcq',
      stem: 'The skull, sternum, ribs, and scapula are examples of which type of bone by shape?',
      options: ['Long', 'Short', 'Flat', 'Irregular'],
      correct: 2,
      answer: 'These are flat bones, built as two compact layers with spongy bone between. Irregular bones such as the vertebrae and sacrum have a mixed shape that fits no other category.',
    },
    {
      kind: 'mcq',
      stem: 'The skull, vertebral column, ribs, and sternum together form which division of the skeleton?',
      options: ['Axial skeleton', 'Appendicular skeleton', 'Visceral skeleton', 'Sesamoid group'],
      correct: 0,
      answer: 'The axial skeleton (80 bones) is the central axis: skull, vertebral column, ribs, and sternum. The appendicular skeleton (126 bones) is the limbs and their girdles.',
    },
    {
      kind: 'mcq',
      stem: 'How many bones make up the adult human skeleton?',
      options: ['126', '206', '80', '270'],
      correct: 1,
      answer: 'The adult skeleton has 206 bones, split into the axial (80) and appendicular (126) divisions. Neonates have more (about 270 to 305) because many bones have not yet fused.',
    },
    {
      kind: 'mcq',
      stem: 'The longest, strongest, and heaviest bone in the human body is the:',
      options: ['tibia', 'humerus', 'femur', 'sternum'],
      correct: 2,
      answer: 'The femur (thigh bone) is the longest, strongest, and heaviest bone in the body. In the pelvis, the ilium is the largest bone and the ischium is the strongest.',
    },
    {
      kind: 'mcq',
      stem: 'Freely movable joints such as the shoulder and hip are classified as:',
      options: ['synarthrosis', 'amphiarthrosis', 'diarthrosis', 'gomphosis'],
      correct: 2,
      answer: 'Diarthroses are freely movable (synovial) joints, including ball-and-socket joints of the shoulder and hip. Synarthroses are immovable and amphiarthroses are only slightly movable.',
    },
    {
      kind: 'mcq',
      stem: 'Immovable joints such as the sutures of the skull are classified as:',
      options: ['synarthrosis', 'amphiarthrosis', 'diarthrosis', 'symphysis'],
      correct: 0,
      answer: 'Synarthroses are immovable joints, including skull sutures, gomphoses (teeth in sockets), and synchondroses. Amphiarthroses (such as the pubic symphysis) allow slight movement, and diarthroses move freely.',
    },
    {
      kind: 'mcq',
      stem: 'The peripheral nervous system contains how many pairs of cranial nerves?',
      options: ['10', '12', '31', '8'],
      correct: 1,
      answer: 'The peripheral nervous system has 12 pairs of cranial nerves and 31 pairs of spinal nerves. The 31 spinal pairs are the ones that arise from the spinal cord.',
    },
    {
      kind: 'mcq',
      stem: 'The left side of the heart pumps oxygenated blood to the body through which circuit?',
      options: ['pulmonary circuit', 'systemic circuit', 'portal circuit', 'coronary circuit'],
      correct: 1,
      answer: 'The left side of the heart drives the systemic circuit, sending oxygenated blood to the body. The right side drives the pulmonary circuit, sending deoxygenated blood to the lungs.',
    },
    {
      kind: 'mcq',
      stem: 'Pulmonary surfactant, which reduces surface tension in the alveoli, is produced by:',
      options: ['type I pneumocytes', 'type II pneumocytes', 'goblet cells', 'alveolar macrophages'],
      correct: 1,
      answer: 'Type II pneumocytes produce surfactant, which lowers alveolar surface tension and keeps the alveoli from collapsing. A deficiency causes respiratory distress syndrome. Type I pneumocytes handle gas exchange.',
    },
  ],
}
