          ...
          blocks: [
            {
              ...
              rows: [
                ['Fluoroquinolones', 'Ciprofloxacin 0.3%, ofloxacin 0.3%, levofloxacin 0.5%, moxifloxacin 0.5%, gatifloxacin 0.3%', 'Broad spectrum; bacterial conjunctivitis, corneal ulcers, endophthalmitis prophylaxis; excellent corneal penetration'],
                ['Aminoglycosides', 'Gentamicin 0.3%, tobramycin 0.3%, neomycin', 'Gram-negative coverage (Pseudomonas); tobramycin is preferred; S/E: superficial keratitis'],
                ['Chloramphenicol', 'Chloramphenicol 0.5%', 'Broad spectrum; S/E: aplastic anemia; optic neuritis/atrophy'],
                ['Sulfonamides', 'Sulfacetamide 10%, 15%, 30%', 'Bacteriostatic; broad spectrum; contact dermatitis; cornea verticillata with systemic use'],
                ['Macrolides', 'Erythromycin 0.5% ointment, azithromycin', 'Chlamydial infections, Gram-positive organisms'],
                ['Tetracyclines', 'Tetracycline, doxycycline (oral)', 'Chlamydia, rosacea; oral for meibomian gland dysfunction; S/E: induces myopia'],
                ['Polymyxin B combinations', 'Polymyxin B + trimethoprim (Polytrim), Polymyxin B + neomycin + bacitracin', 'Gram-negative bacteria; prophylaxis'],
                ['Bacitracin', 'Bacitracin ointment', 'Gram-positive coverage; pre-op prophylaxis'],
              ],
            },
            {
              kind: 'pearl',
              content: 'Fluoroquinolones are now first-line for bacterial corneal ulcers due to excellent broad-spectrum coverage and corneal penetration. Gentamicin and neomycin can cause superficial keratitis with prolonged use. Chloramphenicol = aplastic anemia risk (blood dyscrasia).',
            },
          ],
        },
        {
